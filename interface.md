...
- Охарактеризуйте проблемы и тенденции развития человеко-машинных интерфейсов
- Основные понятия оценки эффективности интерфейса (GOMS)
- Разработка интерфейсов в стиле Metro (блочно)
- Диалоговые окна и меню (одноуровневое, многоуровневое, открытое, закрытое) в программах
- Правило размещения информации на экране. Что такое шаблон экрана?
- Виды интерфейсов
- Основные психологические особенности работы пользователя с программой
- Свойства интерфейсов
- Требования к пользовательскому интерфейсу с точки зрения его функциональности
- Охарактеризуйте пользовательские интерфейсы мобильных устройств
