...
Вставка данных с другой таблицы
```
insert into table1 (attr1, attr2)
select attr1, attr2 from table2
```

*24.09.2020*

> Предикат выборки - условие отбора
...
Если count(...) == count(distinct ...) - это поле с уникальными значениями

В GROUP BY нельзя включать уникальные поля

Если WHERE должен включать результат агрегатной функции, её нужно включать в HAVING

SELECT ... FROM ... WHERE ... GROUP BY ... HAVING ... ORDER BY ...

HAVING имеет доступ только к полю GROUP BY и результату функции агрегации
